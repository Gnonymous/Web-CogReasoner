...
TEST_JSON_PATH = "/code/Web-CogReasoner/benchmark/Exploring/Popup_Close.json"
OUTPUT_JSON_PATH = f"/code/Web-CogReasoner/results_Web-CogBench/{Model_name}-Popup_close.json"
