...
# Config
TEST_JSON_PATH = str(PROJECT_ROOT / "benchmark/VisualWebBench/VisualWebBench_Action_Ground_103.json")
MODEL_NAME = "qwen2vl"
MAX_SAMPLE = 103
MAX_CONCURRENT_REQUESTS = 10
ACCURACY_PRINT_INTERVAL = 10
OUTPUT_JSON_PATH = str(PROJECT_ROOT / f"results_VisualWebBench/{Test_Model}-VisualWebBench_Action_Ground_103.json")
