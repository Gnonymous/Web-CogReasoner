...
# ===== Configuration Items =====
TEST_JSON_PATH = "/code/CogReasoner/Test/Action_Prediction.json" # Path to the test set JSON file
MODEL_NAME = "us.anthropic.claude-sonnet-4-20250514-v1:0" # Specify the Claude model name for inference
MAX_SAMPLE = 44 # Maximum number of samples to test
...
OUTPUT_JSON_PATH = f"/code/CogReasoner/Code/Evalaute/Result/Test-{Test_Model}-Action_Prediction.json" # Path where inference results will be saved
