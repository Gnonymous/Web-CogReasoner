...
# Config
TEST_JSON_PATH = "/code/Web-CogReasoner/benchmark/VisualWebBench/VisualWebBench_webqa.json"
OUTPUT_JSON_PATH = f"/code/Web-CogReasoner/results_VisualWebBench/{Test_Model}-VisualWebBench_WebQA.json"
MAX_SAMPLE = 245
