...
Test_JSON_PATH = "/code/Web-CogReasoner/benchmark/Understanding/Element_Understanding_sampled_200_clean.json"
Inference_output_file = f"/code/Web-CogReasoner/results_Web-CogBench/Raw_Answer-{Test_Model}-Element_Understanding_200.jsonl"
OUTPUT_JSON_PATH = f"/code/Web-CogReasoner/results_Web-CogBench/{Test_Model}-Element_Understanding_200.json"
