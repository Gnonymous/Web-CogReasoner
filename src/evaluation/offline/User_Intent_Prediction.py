...
Test_JSON_PATH = "/code/Web-CogReasoner/benchmark/Exploring/User_Intent_Prediction.json"
Inference_output_file = f"/code/Web-CogReasoner/results_Web-CogBench/Raw_Answer-{Test_Model}-User_Intent_Prediction.jsonl"
OUTPUT_JSON_PATH = f"/code/Web-CogReasoner/results_Web-CogBench/{Test_Model}-User_Intent_Prediction.json"
